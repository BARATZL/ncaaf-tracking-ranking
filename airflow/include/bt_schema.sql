...
CREATE TABLE IF NOT EXISTS bt.team_stats (
    ...
    FOREIGN KEY (team_id) REFERENCES real_deal.dim_team(team_id)
);
...
CREATE TABLE IF NOT EXISTS bt.pairwise_comparisons (
    ...
    FOREIGN KEY (game_id) REFERENCES real_deal.dim_game(game_id),
    FOREIGN KEY (team_a_id) REFERENCES real_deal.dim_team(team_id),
    FOREIGN KEY (team_b_id) REFERENCES real_deal.dim_team(team_id)
);
...
CREATE TABLE IF NOT EXISTS bt.matchup_predictions (
    ...
    FOREIGN KEY (team_a_id) REFERENCES real_deal.dim_team(team_id),
    FOREIGN KEY (team_b_id) REFERENCES real_deal.dim_team(team_id),
    FOREIGN KEY (home_team_id) REFERENCES real_deal.dim_team(team_id),
    FOREIGN KEY (actual_game_id) REFERENCES real_deal.dim_game(game_id),
    FOREIGN KEY (actual_winner_id) REFERENCES real_deal.dim_team(team_id),
